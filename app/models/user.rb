...
class User < ApplicationRecord
  ...
  # validates(:phone, { :numericality => true , :allow_nill => true })
  # validates(:phone, { :uniqueness => { :allow_blank => true } })
  validates(:last_name, { :presence => true })
  validates(:kids6_age, { :numericality => { :greater_than_or_equal_to => 0 , :allow_blank => true } })
  validates(:kids5_age, { :numericality => { :greater_than_or_equal_to => 0 , :allow_blank => true } })
  validates(:kids4_age, { :numericality => { :greater_than_or_equal_to => 0 , :allow_blank => true} })
  validates(:kids3_age, { :numericality => { :greater_than_or_equal_to => 0 , :allow_blank => true } })
  validates(:kids2_age, { :numericality => { :greater_than_or_equal_to => 0 , :allow_blank => true } })
